...
public class RevenueBreakdownTests
{
    ...
    {
        // Arrange
        var ticketPrice = new Money(100m, Currency.USD);
        ...
        // Verify Stripe Fee: ($93.46 Ã— 0.029) + $0.30 = $3.01
        breakdown.StripeFeeAmount.Amount.Should().BeApproximately(3.01m, 0.01m);

        // Verify Platform Commission: $93.46 Ã— 0.02 = $1.87
    ...
    [Theory]
    [InlineData(10.00, 0.07, 8.59)]   // $10 ticket, 7% tax â†’ $8.59 payout
    [InlineData(25.00, 0.08, 21.71)]  // $25 ticket, 8% tax â†’ $21.71 payout
    [InlineData(50.00, 0.065, 44.35)] // $50 ticket, 6.5% tax â†’ $44.35 payout
    [InlineData(100.00, 0.0725, 88.37)] // $100 ticket, 7.25% tax â†’ $88.37 payout
    ...
    public void Create_WithZeroTaxRate_ShouldCalculateWithoutTax()
    {
        ...
        // Platform Commission: $100 Ã— 0.02 = $2.00
    ...
    public void Create_WithVeryLowPrice_ShouldNotProduceNegativePayout()
    {
        ...
        var ticketPrice = new Money(2.00m, Currency.USD);
        var taxRate = 0.07m;
    ...
    public void Create_WithPriceTooLowForFees_ShouldFail()
    {
        ...
        var ticketPrice = new Money(0.20m, Currency.USD);
        var taxRate = 0.07m;
    ...
    {
        // Arrange
        var ticketPriceUSD = new Money(100m, Currency.USD);
        var ticketPriceLKR = new Money(100m, Currency.LKR);
    ...
    public void Create_ShouldCalculate_TaxInclusivePricing_Correctly()
    {
        ...
        // 4. Stripe Fee (SF) = ($93.24 Ã— 0.029) + $0.30 = $3.00
        ...
        // 5. Platform Commission (PC) = $93.24 Ã— 0.02 = $1.86
