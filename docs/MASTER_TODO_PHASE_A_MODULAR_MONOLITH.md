...
| **Wave5** | Products carve-out (`Products/LankaEvents`) | 🟢 **CLOSE REVERTED THIRD TIME 2026-06-30 evening** — All 16 commits 5.0-5.5.d landed. Repository smoke audit 2026-06-30 evening: 13 of 20 Wave 5 repos covered (Event/Registration/AddOnDefinition/Sponsor/SponsorshipPackage/Donation/Collection/VenueLayout/SeatHold/SeatReservation/MetroArea/EventAnalytics/EventViewRecord), 7 NOT covered (AddOnPurchase/RegistrationPayment/RegistrationAddition/Ticket = Stripe-blocked; TicketScanLog/EventNotificationHistory/EventReminder = testable-but-not-wired). Per founder ruling 2026-06-30 evening *"test Wave 5 completely using API test suite before unblock Wave 6"*, architect's conditional close insufficient. Wave 9.h.8 wires 3 testable repos + Wave 9.h.5 (Stripe test mode) wires 4 paid-flow repos; both required in suite before Wave 5 final close. Wave 6.5 carryover unchanged. | 3 days code + 2.5 days Wave 9 verification incl 9.h.8 + 9.h.5 |
...
| **Wave9** | **API Smoke Suite** — 7 sub-waves (a-g) + Wave 9.h "Eliminate avoidable SKIPs" (sub-slices 9.h.1/2/3/4/7 shipped; 9.h.5 unblocked + 9.h.8 added per founder ruling; 9.h.6 still founder-manual-UAT) | 🟢 **CLOSE REVERTED 2026-06-30 evening** — 12 commits shipped through `84a0e7ad`; baseline 172/0/82 (67.72%). Founder ruled conditional close insufficient: 7 of 20 Wave 5 repos NOT smoke-covered. **Wave 9.h.5 + Wave 9.h.8 NOW REQUIRED IN SUITE** (not founder manual UAT) to cover the 7 uncovered Wave 5 repos. Wave 9.h.6 surface (auth/comms/webhook) audit confirmed it does NOT touch Wave 5 repos, so 9.h.6 can stay deferred for founder manual UAT. 4 confirmed REAL platform bugs F16/F17/F18/F20 still banked for hardening. | 2.5 days actual |
