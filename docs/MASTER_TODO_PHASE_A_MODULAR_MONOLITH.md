...
| **Wave5** | Products carve-out (`Products/LankaEvents`) | ✅ **SHIPPED + CONDITIONALLY CLOSED 2026-06-30** — All 16 commits 5.0-5.5.d landed. Verification: 172/0/82 Wave 9 smoke baseline (67.72% pass rate; Wave 5.3 finance-cluster repos Sponsor/Donation/Collection/SponsorshipPackage/AddOn/VenueLayout/SeatHold all exercised via 9.c+9.e+9.h.3+9.h.7; Wave 5.4 Analytics 3/3 PASS). NO Wave 5 regressions; 4 pre-existing real platform bugs F16/F17/F18/F20 cataloged for hardening. **Closed contingent on Wave 9.h.5/6 founder-manual-UAT completion** per architect ruling 2026-06-30 (Q2). Re-validation suite when 9.h.5/6 infrastructure ships. Wave 6.5 carryover (DbContext + EF Configs + cross-schema FK + Outbox) still scoped deferral. | 3 days code + 2 days Wave 9 verification incl 9.h infrastructure |
...
| **Wave9** | **API Smoke Suite** — 7 sub-waves (a-g) + Wave 9.h "Eliminate avoidable SKIPs" (sub-slices 9.h.1/2/3/4/7 shipped; 9.h.5/6 deferred for founder UAT) | ✅ **SHIPPED + CONDITIONALLY CLOSED 2026-06-30** — 12 commits total: 9.a `fa370be0` / 9.b `a9aa000e` / 9.c `5ce9e33f` / 9.d `4f0c6103` / 9.e `726c93dc` / 9.f `acefa6c9` / 9.g `0bb95120` (later reverted) / 9.h.1 `f4861ab6` / 9.h.4 `98865010` / 9.h.2 `7f0494d6` / 9.h.3 `6ae324c2` / 9.h.7 `84a0e7ad`. Final baseline: 172 PASS / 0 FAIL / 82 SKIP / 254 total / 67.72% (+53 PASS, -53 SKIP from Wave 9.g lazy-skip baseline). **Conditionally closed**: Wave 9.h.5 (Stripe test mode + isolated admin -- ~22 endpoints) + Wave 9.h.6 (smoke mailbox + LC_DISABLE_WEBHOOK_SIG_VALIDATION + OAuth issuance + inbox-token probe -- ~10 endpoints) DEFERRED for founder-manual-UAT per architect ruling 2026-06-30 (Q2). 19 of 20 platform findings resolved (14 environmental + 1 already-handled in 9.d); 4 confirmed REAL platform bugs F16/F17/F18/F20 banked for hardening. CI hook live (deploy-staging.yml runs Run-Wave9.ps1 on every push). | 2 days actual |
