                ...
                <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-blue-50">
                  <CardHeader>
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-purple-900">Event Organizer Contact</CardTitle>
                    </div>
                    <CardDescription>
                      Get in touch with the event organizer
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-gray-900">{event.organizerContactName}</p>
                        </div>
                      </div>
