 ...
 * Video sits BEHIND the banner gradient. Banner fades to reveal the video
 * on the right side. Subtle theater curtain drapes + dark surround tint
 * on the edges give the cinema feel. No visible container/border.
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Layer 3: Gradient overlay — banner colors fading to transparent + dark theater tint */}
        {/* Left-to-right: opaque banner → transparent (reveals video) */}
        <div className="absolute inset-0 pointer-events-none hidden lg:block" style={{
          background: `linear-gradient(to right,
            rgba(234,88,12,1) 0%,
            rgba(190,50,35,1) 15%,
            rgba(159,18,57,1) 28%,
            rgba(120,15,45,0.7) 38%,
            rgba(40,20,30,0.35) 50%,
            transparent 62%)`,
        }} />
        {/* Top edge — dark theater ceiling tint */}
        <div className="absolute top-0 left-0 right-0 h-24 pointer-events-none hidden lg:block" style={{
          background: 'linear-gradient(to bottom, rgba(20,10,15,0.7) 0%, rgba(20,10,15,0.2) 50%, transparent 100%)',
        }} />
        {/* Bottom edge — dark theater floor tint */}
        <div className="absolute bottom-0 left-0 right-0 h-28 pointer-events-none hidden lg:block" style={{
          background: 'linear-gradient(to top, rgba(10,20,18,0.7) 0%, rgba(10,20,18,0.2) 50%, transparent 100%)',
        }} />
        {/* Right edge — dark surround + subtle curtain */}
        <div className="absolute right-0 top-0 bottom-0 w-14 pointer-events-none hidden lg:block" style={{
          background: 'linear-gradient(to left, rgba(80,15,15,0.7) 0%, rgba(80,15,15,0.3) 40%, transparent 100%)',
        }} />
        {/* Top curtain valance hint */}
        <div className="absolute top-0 left-[30%] right-0 h-4 pointer-events-none hidden lg:block" style={{
          background: 'linear-gradient(180deg, rgba(127,29,29,0.6) 0%, transparent 100%)',
        }} />
