...
namespace LankaConnect.Products.LankaEvents.Infrastructure.Migrations
{
    ...
    [Migration("20260704002856_Baseline_LankaEvents")]
    partial class Baseline_LankaEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            // Wave 6.5.e (2026-07-03): OutboxMessage / DeadLetterMessage /
            // IdempotencyKey entries intentionally removed so the follow-up
            // Wave6_5_e_AddLankaEventsOperationalTables migration diffs into
            // a real CREATE-TABLE payload for `events.outbox`,
            // `events.outbox_dead_letter`, and `events.idempotency_keys`.
            // See LankaEventsDbContextModelSnapshot.cs for the mirror comment.
            modelBuilder.Entity("LankaConnect.Domain.Analytics.EventAnalytics", b =>
                {
                    ...
                    b.ToTable("event_analytics", "events");
                });
            ...
            modelBuilder.Entity("LankaConnect.Domain.Analytics.EventViewRecord", b =>
                {
                    ...
                    b.ToTable("event_view_records", "events");
                });
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.SignUpCommitment", b =>
                {
                    ...
                    b.ToTable("SignUpCommitments", "events");
                });
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.TicketScanLog", b =>
                {
                    ...
                    b.ToTable("TicketScanLogs", "events");
                });
