...
| 7E.1  | Domain model + migration + EF config | 🔧 In Progress | Local: code complete + 2292/2298 tests green (27 new Phase 7E.1 tests). Migration `20260426010920_Phase7E1_AddRegistrationMode` adds `events.events.registration_mode` smallint NOT NULL DEFAULT 0, `events.registrations.registration_mode` (snapshot) NOT NULL DEFAULT 0, `lead_attendee_name` varchar(200) NULL, `head_count` jsonb NULL. Pushing to staging next. |
