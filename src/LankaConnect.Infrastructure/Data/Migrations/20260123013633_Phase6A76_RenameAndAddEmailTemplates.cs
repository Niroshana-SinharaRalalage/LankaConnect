...
namespace LankaConnect.Infrastructure.Data.Migrations
{
    ...
    public partial class Phase6A76_RenameAndAddEmailTemplates : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates (id, name, description, category, type, subject, html_body, plain_text_body, is_active, version, created_at, updated_at)
                SELECT
                    gen_random_uuid(),
                    'template-password-reset',
