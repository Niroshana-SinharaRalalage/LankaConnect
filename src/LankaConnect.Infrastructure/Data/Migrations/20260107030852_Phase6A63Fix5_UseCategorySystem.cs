...
{
    /// <inheritdoc />
    public partial class Phase6A63Fix5_UseCategorySystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Phase 6A.63 FIX 5: Update category to 'System' (matching working registration-confirmation template)
            // Phase6A63Fix3 and Fix4 used 'Event' which is INVALID - registration uses 'System' and works
            // Valid EmailTemplateCategory values: Authentication, Business, Marketing, System, Notification
            migrationBuilder.Sql(@"
                UPDATE communications.email_templates
                SET category = 'System'
                WHERE name = 'event-cancelled-notification' AND category != 'System';
            ");
