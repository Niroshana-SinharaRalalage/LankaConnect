...
export function EventNewslettersTab({ eventId, eventTitle }: EventNewslettersTabProps) {
  ...
  // Phase 6A.98: Local state for publication processing and inline message
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border rounded-lg p-6 bg-white shadow-sm">
        ...
        {/* Publication History - Phase 6A.98: Updated with inline processing/success messages */}
        <div className="border-t pt-4">
          ...
          {showPublicationProcessing && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-blue-900">Sending email...</p>
                  <p className="text-sm text-blue-700">Queuing emails to recipients. This will update shortly.</p>
                </div>
              </div>
            </div>
          )}

          {/* Phase 6A.98: Show inline success/error message */}
          {publicationMessage && !showPublicationProcessing && (
            <div className={`rounded-lg p-4 mb-3 ${
              publicationMessage.type === 'success'
              ...
              <div className="flex items-center gap-3">
                ...
                <p className={`font-medium ${
                  publicationMessage.type === 'success' ? 'text-green-900' : 'text-red-900'
                }`}>
          ...
          {history && history.length === 0 && !showPublicationProcessing && !publicationMessage && (
          ...
          <>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {sendReminderMutation.isPending ? 'Sending reminder...' : 'Send Custom Reminder'}
              </Button>
            </div>
