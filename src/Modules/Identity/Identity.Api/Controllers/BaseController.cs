...
// (no /api/{controller} prefix) — /api/Users, /api/AdminUsers etc all returned
// 404 on staging, blocking 20+ Wave 9 smoke tests in this assembly.
[ApiController]
...
public abstract class BaseController<T> : ControllerBase where T : class
{
    ...
    // 4C.d.xiii: local copy of GetClientIpAddress used by EventsController
    // for ticket-scan audit-log client_ip column (was on original Host BaseController).
