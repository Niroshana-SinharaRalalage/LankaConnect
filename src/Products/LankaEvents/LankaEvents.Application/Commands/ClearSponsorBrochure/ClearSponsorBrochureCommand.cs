...
namespace LankaConnect.Products.LankaEvents.Application.Commands.ClearSponsorBrochure;

/// <summary>
/// Phase 6A.162 — clears a sponsor's brochure/flyer image. Idempotent
/// (succeeds when no brochure set). Mirrors
/// <see cref="LankaConnect.Products.LankaEvents.Application.Commands.ClearSponsorImage.ClearSponsorImageCommand"/>
