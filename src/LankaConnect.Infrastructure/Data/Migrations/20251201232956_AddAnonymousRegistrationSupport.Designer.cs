...
namespace LankaConnect.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251201232956_AddAnonymousRegistrationSupport")]
    partial class AddAnonymousRegistrationSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Registration", b =>
                {
                    ...
                    b.ToTable("registrations", "events", t =>
                        {
                            t.HasCheckConstraint("ck_registrations_user_xor_attendee", "(user_id IS NOT NULL AND attendee_info IS NULL) OR (user_id IS NULL AND attendee_info IS NOT NULL)");
                        });
                });
