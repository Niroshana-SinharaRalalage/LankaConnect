...
"[project]/src/domain/data/mockFeedData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mockFeedItems = [
    // EVENTS (6 items)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$models$2f$FeedItem$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFeedItem"])({
        type: 'event',
        author: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$data$2f$mockFeedData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/domain/data/mockFeedData.ts [app-ssr] (ecmascript)");
 ...
 */ function HomeContent() {
    const { selectedMetro } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$components$2f$features$2f$location$2f$MetroAreaContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMetroArea"])();
    ...
    const filteredItems = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>{
        let items = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$data$2f$mockFeedData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockFeedItems"];
        // Filter by metro area
        if (selectedMetro) {
            const metro = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$constants$2f$metroAreas$2e$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OHIO_METRO_AREAS"].find((m)=>m.id === selectedMetro);
            if (metro) {
                items = items.filter((item)=>{
                    // Check if item location matches any city in the metro area
                    const itemCity = item.location.split(',')[0].trim();
                    return metro.cities.some((city)=>city === itemCity) || item.location.includes(metro.state);
                });
            }
        }
        // Filter by tab
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eaece1ea._.js.map