...
public class PaymentsController : ControllerBase
{
    ...
    ///   1. Workflow-line lookup via <see cref="LankaConnect.Products.LankaEvents.Contracts.Repositories.IRefundRequestRepository.GetWorkflowLineByStripeRefundIdAsync"/>
