...
- Master TODO `MASTER_TODO_E1_PHASE_C.md` closed — both PR-A (E1 address optional) and PR-B (Phase C reorder + UX follow-ups 1/2/3) shipped to staging and verified end-to-end. Browser-smoke confirmation of the arrow-button UX + tab-stickiness on staging remains the one human-gated gap.
