...
_s(Header, "xKXXkOPZi8SQjjtj0fQ3FZAnlKY=", false, function() {
    return [
...
"[project]/src/presentation/utils/dateRanges.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$constants$2f$metroAreas$2e$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/domain/constants/metroAreas.constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$utils$2f$dateRanges$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/utils/dateRanges.ts [app-client] (ecmascript)");
...
function EventsPage() {
    ...
    const { metroAreasByState, stateLevelMetros, isLoading: metrosLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$hooks$2f$useMetroAreas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMetroAreas"])();
    // Filter states
    ...
    const [selectedMetroIds, setSelectedMetroIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedState, setSelectedState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [dateRangeOption, setDateRangeOption] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('upcoming');
    ...
    const filters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventsPage.useMemo[filters]": ()=>{
            const dateRange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$utils$2f$dateRanges$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDateRangeForOption"])(dateRangeOption);
            return {
    ...
    const { data: events, isLoading: eventsLoading, error: eventsError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$hooks$2f$useEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEvents"])(filters);
    // Convert metro areas to tree structure for TreeDropdown
    const locationTreeNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventsPage.useMemo[locationTreeNodes]": ()=>{
            const nodes = [];
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$domain$2f$constants$2f$metroAreas$2e$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["US_STATES"].forEach({
                "EventsPage.useMemo[locationTreeNodes]": (state)=>{
                    const metrosForState = metroAreasByState.get(state.code) || [];
                    if (metrosForState.length === 0) return;
                    // Separate state-level and city-level metros
                    const stateMetro = metrosForState.find({
                        "EventsPage.useMemo[locationTreeNodes].stateMetro": (m)=>m.isStateLevelArea
                    }["EventsPage.useMemo[locationTreeNodes].stateMetro"]);
                    const cityMetros = metrosForState.filter({
                        "EventsPage.useMemo[locationTreeNodes].cityMetros": (m)=>!m.isStateLevelArea
                    }["EventsPage.useMemo[locationTreeNodes].cityMetros"]);
                    const children = [];
                    ...
                    cityMetros.forEach({
                        "EventsPage.useMemo[locationTreeNodes]": (metro)=>{
                            children.push({
                                id: metro.id,
                                label: metro.name,
                                checked: selectedMetroIds.includes(metro.id)
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    ...
                                                    Object.entries(categoryLabels).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                                                        }, value, false, {
                                                            fileName: "[project]/src/app/events/page.tsx",
...
_s(EventsPage, "Sv3a4DNhWvgkigQ5hpyQ1+eOuno=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    event.images && event.images.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
...
//# sourceMappingURL=src_fa8b2825._.js.map