#!/bin/bash
# Phase 6 E2E API Test - Scenario 1: Create Free Event (With Authentication)
...
TEST_NAME="Scenario 1: Free Event Creation (Authenticated)"
TIMESTAMP=$(date +%s)

# Auth token from login endpoint (expires at 2025-12-04T20:38:42Z)
AUTH_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..TKC93DM5LvNZlJcYcFRXUNhjaqRR3GQopmYOhCKX-m4"
