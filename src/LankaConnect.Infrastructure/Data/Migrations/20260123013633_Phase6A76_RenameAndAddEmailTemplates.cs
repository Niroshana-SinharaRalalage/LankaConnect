        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                SELECT
                    ...
                    'Hello {{UserName}}, Welcome to LankaConnect! Thank you for joining our community. With LankaConnect, you can discover local events and activities, connect with your community, create and manage your own events, and stay updated with newsletters. Visit {{DashboardUrl}} to get started. If you have any questions, our support team is here to help.',
                    '<!DOCTYPE html><html><head><meta charset=""utf-8""><title>Welcome</title></head><body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;""><div style=""background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;""><h1 style=""color: white; margin: 0; font-size: 28px;"">Welcome to LankaConnect!</h1></div><div style=""background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;""><p>Hello {{UserName}},</p><p>Thank you for joining LankaConnect! We''re excited to have you as part of our community.</p><p>With LankaConnect, you can:</p><ul><li>Discover local events and activities</li><li>Connect with your community</li><li>Create and manage your own events</li><li>Stay updated with newsletters</li></ul><div style=""text-align: center; margin: 30px 0;""><a href=""{{DashboardUrl}}"" style=""background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;"">Get Started</a></div><p>If you have any questions, our support team is here to help.</p><hr style=""border: none; border-top: 1px solid #eee; margin: 20px 0;""><p style=""color: #999; font-size: 12px; text-align: center;"">&copy; {{Year}} LankaConnect. All rights reserved.</p></div></body></html>',
                    true,
