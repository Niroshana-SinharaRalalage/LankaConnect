...
**Phase A**: W3 CLOSED; W4 OPEN — Communications + Media skeletons (W4.1.1 + W4.2.1) landed; W4.1.2 + W4.2.2 (domain type moves) next.
...
*Earlier (2026-06-04, Phase A W3.8 staging deploy + flag flip verified + W3.9 playbook written + W3.10 close-out)
