...
ONGOING_DISCIPLINE: API smoke suite (pwsh ./scripts/smoke/Run-Wave9.ps1) remains per-slice testing mechanism. New floor = 331/6/50 (85.5% pass) reference; regression below is hard-STOP.
