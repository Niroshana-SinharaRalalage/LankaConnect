...
"[project]/src/infrastructure/api/services/tokenRefreshService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TokenRefreshService {
   ...
   */ async refreshAccessToken() {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/Auth/refresh', {});
            ...
            const { clearAuth } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"].getState();
            clearAuth();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$services$2f$tokenRefreshService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/api/services/tokenRefreshService.ts [app-client] (ecmascript)");
;
;
;
class ApiClient {
            ...
            if (error.response?.status === 401 && !originalRequest._retry) {
                ...
                if (!isAuthEndpoint) {
                    ...
                    try {
                        ...
                        const newToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$services$2f$tokenRefreshService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenRefreshService"].refreshAccessToken();
   ...
   */ handleError(error) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAxiosError(error)) {
            ...
            switch(status){
                case 400:
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ValidationError"](message, data?.errors || data?.validationErrors, axiosError.response);
                case 401:
                ...
                default:
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"](message, status, undefined, axiosError.response);
            }
        }
        // Unknown error
...
"[project]/src/infrastructure/utils/jwtDecoder.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/presentation/hooks/useTokenRefresh.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/store/useAuthStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$utils$2f$jwtDecoder$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/utils/jwtDecoder.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$services$2f$tokenRefreshService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/api/services/tokenRefreshService.ts [app-client] (ecmascript)");
...
function useTokenRefresh() {
    _s();
    const { accessToken, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useTokenRefresh.useEffect": ()=>{
            ...
            const refreshTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$utils$2f$jwtDecoder$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRefreshTime"])(accessToken);
            if (!refreshTime) {
            ...
            if (timeUntilRefresh <= 0) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$services$2f$tokenRefreshService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenRefreshService"].refreshAccessToken().catch({
                    "useTokenRefresh.useEffect": (error)=>{
            ...
            }["useTokenRefresh.useEffect"], timeUntilRefresh);
            // Cleanup function
            return ({
                "useTokenRefresh.useEffect": ()=>{
                    if (timerRef.current) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useTokenRefresh.useEffect": ()=>{
            ...
            const checkInterval = setInterval({
                "useTokenRefresh.useEffect.checkInterval": ()=>{
                    const timeRemaining = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$utils$2f$jwtDecoder$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTimeUntilExpiration"])(accessToken);
                    ...
                    if (timeRemaining < 5 * 60 * 1000 && timeRemaining > 0) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$services$2f$tokenRefreshService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenRefreshService"].refreshAccessToken().catch({
                            "useTokenRefresh.useEffect.checkInterval": (error)=>{
                                console.error('❌ Periodic token refresh failed:', error);
                            }
                        }["useTokenRefresh.useEffect.checkInterval"]);
                    }
                }
            }["useTokenRefresh.useEffect.checkInterval"], 60 * 1000); // Check every minute
            return ({
                "useTokenRefresh.useEffect": ()=>clearInterval(checkInterval)
            })["useTokenRefresh.useEffect"];
        }
    }["useTokenRefresh.useEffect"], [
        accessToken,
...
_s(useTokenRefresh, "jXk2ua4pto7+7KQEch7O8Br3Iy0=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/infrastructure/api/client/api-client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/store/useAuthStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$hooks$2f$useTokenRefresh$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/hooks/useTokenRefresh.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AuthProvider({ children }) {
    ...
    // Automatically refreshes token 5 minutes before expiration
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$hooks$2f$useTokenRefresh$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTokenRefresh"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(AuthProvider, "xLwWxiiuaX6etvBcJxi/hvBnbAQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$hooks$2f$useTokenRefresh$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTokenRefresh"]
    ];
});
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=src_7601fe48._.js.map