...
function Header({ className = '' }) {
    _s();
    const { user, isAuthenticated, isHydrated, clearAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
...
_s(Header, "Q0n9Dskm9UwkmmR3k+Z6cFN0/P4=", false, function() {
    return [
...
class EventsRepository {
   ...
   */ async cancelRsvp(eventId, deleteSignUpCommitments = false) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`${this.basePath}/${eventId}/rsvp${params}`);
    }
    /**
   ...
   */ async downloadTicketPdf(eventId) {
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$api$2f$client$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`${this.basePath}/${eventId}/my-registration/ticket/pdf`, {
            responseType: 'blob'
        });
    }
    /**
