...
public class EventConfiguration : IEntityTypeConfiguration<Event>
{
    public void Configure(EntityTypeBuilder<Event> builder)
    {
        ...
        // 2026-06-12: HasQueryFilter REMOVED. The corrupt-JSONB incident root
        // cause (event ad8903c4 + any other Registration row with embedded
        // 0x00 bytes) was permanently repaired by migration
        // 20260612003753_SanitizeNullBytesInRegistrationJsonb (commit a3df8b31).
        // The defensive filter is no longer needed; the bad event is now
