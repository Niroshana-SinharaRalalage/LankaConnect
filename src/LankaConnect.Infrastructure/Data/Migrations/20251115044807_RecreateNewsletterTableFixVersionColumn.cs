...
{
    /// <inheritdoc />
    public partial class RecreateNewsletterTableFixVersionColumn : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop the existing table with nullable version column
            migrationBuilder.Sql(@"DROP TABLE IF EXISTS communications.newsletter_subscribers CASCADE;");

            // Recreate the table with correct schema (version non-nullable)
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    version = table.Column<byte[]>(type: "bytea", rowVersion: true, nullable: false)  // FIXED: non-nullable
                },
                constraints: table =>
                {
        ...
        {
            // This migration fixes a critical schema bug - cannot be rolled back safely
            throw new NotSupportedException("This migration fixes a critical database schema issue and cannot be rolled back. Restore from backup if needed.");
        }
    }
}
