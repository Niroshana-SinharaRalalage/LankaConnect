...
namespace LankaConnect.SPLIT_PER_ENTITY.Migrations
{
    ...
    [Migration("20251124194005_AddStripePaymentInfrastructure")]
    partial class AddStripePaymentInfrastructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.EventPass", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Description", "LankaConnect.Products.LankaEvents.Domain.Entities.EventPass.Description#PassDescription", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "LankaConnect.Products.LankaEvents.Domain.Entities.EventPass.Name#PassName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Price", "LankaConnect.Products.LankaEvents.Domain.Entities.EventPass.Price#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.PassPurchase", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("TotalPrice", "LankaConnect.Products.LankaEvents.Domain.Entities.PassPurchase.TotalPrice#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.SignUpCommitment", b =>
                {
                    ...
                    b.ToTable("sign_up_commitments", (string)null);
                });
            ...
            modelBuilder.Entity("LankaConnect.Products.LankaEvents.Domain.Entities.SignUpList", b =>
                {
                    ...
                    b.ToTable("sign_up_lists", (string)null);
                });
            ...
            modelBuilder.Entity("LankaConnect.Domain.Users.User", b =>
                {
                    ...
                    b.HasIndex("StripeSubscriptionId")
                        .IsUnique()
                        .HasDatabaseName("ix_users_stripe_subscription_id")
                    ...
                    b.HasIndex("TrialEndDate")
                        .HasDatabaseName("ix_users_trial_end_date");
            ...
            modelBuilder.Entity("LankaConnect.Modules.Communications.Domain.Entities.EmailTemplate", b =>
                {
                    b.OwnsOne("LankaConnect.Modules.Communications.Domain.ValueObjects.EmailSubject", "SubjectTemplate", b1 =>
                        {
