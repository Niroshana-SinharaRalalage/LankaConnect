...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LankaConnect.Domain.Events.Entities.EventPass", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Description", "LankaConnect.Domain.Events.Entities.EventPass.Description#PassDescription", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Name", "LankaConnect.Domain.Events.Entities.EventPass.Name#PassName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Price", "LankaConnect.Domain.Events.Entities.EventPass.Price#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("LankaConnect.Domain.Events.Entities.PassPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("TotalPrice", "LankaConnect.Domain.Events.Entities.PassPurchase.TotalPrice#Money", b1 =>
                        {
                            b1.IsRequired();
