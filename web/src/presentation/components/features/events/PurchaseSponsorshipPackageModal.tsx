...
export function PurchaseSponsorshipPackageModal({
  ...
  // Phase 6A.157-fix-1 [2/3] — buyer logo file (best-effort, optional).
  // Uploaded AFTER purchaseMutation returns sponsorId, BEFORE the Stripe
  // redirect. A failed upload is non-fatal — the buyer's Pending sponsor
