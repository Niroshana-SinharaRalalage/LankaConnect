...
**Phase A**: W3 OPEN — first module extraction (Notifications) underway. W3.1 + W3.2 + W3.3 + W3.4 + W3.5a + W3.5b + W3.6 + W3.7 landed; W3.8 (staging deploy + flag flip + 7-day soak) next.
