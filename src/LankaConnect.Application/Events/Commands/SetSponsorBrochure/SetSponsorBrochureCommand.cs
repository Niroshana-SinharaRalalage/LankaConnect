...
namespace LankaConnect.Application.Events.Commands.SetSponsorBrochure;

/// <summary>
/// Phase 6A.162 — uploads (or replaces) a sponsor's brochure/flyer image
/// (the OPTIONAL second slot, sibling to the logo set by
/// <see cref="LankaConnect.Application.Events.Commands.SetSponsorImage.SetSponsorImageCommand"/>).
///
