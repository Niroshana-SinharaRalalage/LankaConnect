...
{
    /// <summary>
    /// Phase 6A.93: Add 7 missing email templates to the database.
    ///
    /// Problem: EmailTemplateNames.cs defines 28 templates, but only 21 exist in the database.
    /// The missing 7 templates are:
    /// 1. OrganizerCustomEmail - Custom organizer email to event attendees
    /// 2. template-support-ticket-confirmation - Auto-confirmation for contact form submissions
    /// 3. template-support-ticket-reply - Reply notification to ticket submitter
    /// 4. template-account-locked-by-admin - Account locked notification
    /// 5. template-account-unlocked-by-admin - Account unlocked notification
    /// 6. template-account-activated-by-admin - Account activated notification
    /// 7. template-account-deactivated-by-admin - Account deactivated notification
    ///
    /// Root Cause: Phase 6A.90 migration (20260128100000) was missing Designer.cs file and
    /// never got applied to the database. This migration adds all missing templates idempotently.
    /// </summary>
    public partial class Phase6A93_AddMissingEmailTemplates : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Template 1: Organizer Custom Email
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 2: Support Ticket Confirmation
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 3: Support Ticket Reply
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 4: Account Locked by Admin
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 5: Account Unlocked by Admin
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 6: Account Activated by Admin
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            ...
            // Template 7: Account Deactivated by Admin
            migrationBuilder.Sql(@"
                INSERT INTO communications.email_templates
                (
                    ""Id"",
...
<body>
    <div class=""container"">
        ...
        {
            // Remove all Phase 6A.93 email templates
            migrationBuilder.Sql(@"
