...
- [x] **W3.5b (2026-06-03)**: per-schema operational tables landed via the SECOND migration `Add_NotificationsOperationalTables`:
  ...
  - Baseline migration stays a true history-only marker (Up()/Down() unchanged from W3.5a)
  - Full sln build green; ArchTest 9/9 GREEN
