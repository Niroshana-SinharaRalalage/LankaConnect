...
export default function EditSignUpListPage() {
  ...
  useEffect(() => {
    if (!isAuthenticated || !user?.userId) {
      router.push('/login?redirect=' + encodeURIComponent(`/events/${eventId}/manage-signups/${signupId}`));
      return;
    }
        ...
        {hasMandatoryItems && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Required items that must be brought</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {/* Left: Add Item Form */}
        ...
        {hasPreferredItems && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Highly desired items that would be helpful</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {/* Left: Add Item Form */}
        ...
        {hasSuggestedItems && (
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Optional items that would be nice to have</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {/* Left: Add Item Form */}
