...
- **Human-gated gap:** browser/mobile/keyboard smoke on staging UI for (a) the arrow-button UX and (b) tab-stickiness across reorder — cannot be automated from CLI.
