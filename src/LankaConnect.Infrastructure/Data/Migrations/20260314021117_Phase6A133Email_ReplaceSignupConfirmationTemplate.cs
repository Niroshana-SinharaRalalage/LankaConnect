...
namespace LankaConnect.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
    /// <summary>
    /// Phase 6A.133: Replace entire signup-confirmation template with corrected HTML.
    /// Fixes organizer card placement, gradient bleed, and structural issues.
    /// </summary>
    public partial class Phase6A133Email_ReplaceSignupConfirmationTemplate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Replace the entire signup-confirmation template with the corrected HTML
...
<html xmlns=""http://www.w3.org/1999/xhtml"" lang=""en"">
    <head>
        ...
        <title>Sign-Up Confirmed - LankaConnect</title>
        <!--[if mso]>
            <noscript>
                <xml>
                                    ...
                                    <tr>
                                        <td class=""email-body-padding"" style=""padding: 32px 40px 12px"">
                                            ...
                                            <p
                                                ...
                                                ""
                                            >
                                                Thank you for committing to bring items to
                                    ...
                                    <tr>
                                        <td class=""email-body-padding"" style=""padding: 0 40px 24px; text-align: center"">
                                            ...
                                            <p
                                                ...
                                                ""
                                            >
                                                We appreciate your contribution!<br />If you have questions, feel free
